"""
Kubernetes helper functions library

(Some of those functions have better alternatives in native k8s libraries now,
but it was not the case when this file was first created)
...
def findCondition(resource, type):
    conditions = getYamlValue(resource, '/status/conditions') # AppsV1beta1DeploymentStatus objects uses None as empty set
